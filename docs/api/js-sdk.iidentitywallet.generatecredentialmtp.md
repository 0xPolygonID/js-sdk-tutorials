---
id: js-sdk.iidentitywallet.generatecredentialmtp
...
|  --- | --- | --- |
|  did | DID | issuer did |
|  credential | [W3CCredential](./js-sdk.w3ccredential.md) | credential to generate mtp |
|  treeState | [TreeState](./js-sdk.treestate.md) | _(Optional)_ tree state when to generate a proof |
